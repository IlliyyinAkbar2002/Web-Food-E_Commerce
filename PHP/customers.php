<?php
session_start();
require_once '../Template/headerDashboard.php';
...
if (!isset($_SESSION['role_user_id'])) {
...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
            <h3>Customers page <?php echo $_SESSION['name']; ?> !</h3>
            <table class="table">
        <thead>
            <tr>
...
<?php
require_once '../Template/footerDashboard.php';
?>